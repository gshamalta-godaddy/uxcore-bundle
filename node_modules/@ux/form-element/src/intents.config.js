...
export default (function () {
  ...
  // Affecting the border / box-shadow property in the css
  intents.uxFormElementFocused.outlineColor = intents.ux.controlFocused.outlineColor;

  // Overloading the color for validation states onto foreground color
  ...
  // Indicator is ONLY for required asterik
  ...
  // Specifically for checkbox, as currently held within this project
