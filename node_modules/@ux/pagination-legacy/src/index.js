...
export default class Pagination extends React.Component {
  ...
  _warn() {
    ...
    if (!this.props.id && !this.calledWarn &&  this._allowItemsPerPageSelection()) {
      ...
      console.warn('Warning: <Pagination> uses <Dropdown> which requires an id prop to be fully accessible.'); /* eslint-disable-line */
    }
  }
    ...
    return (
      <li className='page-item more'>
        <span className='page-ellipsis'>
          <Ellipsis aria-label={ this.props.ariaLabels.morePages }  />
        </span>
      </li>
    );
  }
  ...
  render() {
    ...
    return (
      <div className={ wrapClass } id={ this.props.id }>
        { selection }
