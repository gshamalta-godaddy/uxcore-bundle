...
export default css`
:global() {
  /* stylelint-disable at-rule-no-vendor-prefix, declaration-no-important, selector-no-qualifying-type, property-no-vendor-prefix, color-no-hex */

  :host,
  :root {
    /* CSS variables that our partner teams can use as font-weight indication for */
    /* our fonts. This allows us to easily change the weights when we move to a */
    /* variable font weight which only allows the use of numeric values. */

    /* The reason for normal font weight of 500 due to the font being thin at lower weights.
    The variable font only goes from 300-700 weights. */

    --uxp-font-weight-normal: 500;
    --uxp-font-weight-semibold: 600;
    --uxp-font-weight-bold: 700;

    /* CSS for for keyboard navigation focus ring */
    --uxp-focus-visible-outline-color: ${intents.ux.box.outlineColor};
  ...
  *::after {
  ...
  /* No focus outline if no .keyboard-navigation */
  ...
  *[tabindex="-1"],
  ...
  ol {
    li {
      margin-top: calc(${intents.ux.box.density} * 3);
  ...
  a {
    color: ${intents.ux.navigate.foregroundColor};
    text-decoration: ${intents.ux.navigate.textDecoration};
    background-color: transparent; /* Remove the gray background on active links in IE 10. */
    &:hover {
      color: ${intents.ux.navigateHovered.foregroundColor};
      text-decoration: ${intents.ux.navigateHovered.textDecoration};
    }
    &.no-underline {
  ...
  caption {
    color: currentColor;
    opacity: .8;
    padding-top: calc(${intents.ux.box.density} * 4);
    padding-bottom: calc(${intents.ux.box.density} * 4);
    text-align: left;
    caption-side: bottom;
  }
  ...
  label {
    font-weight: ${intents.ux.textLabel.fontWeight};
    /* Allow labels to use 'margin' for spacing. */
    display: inline-block;
    /* margin-bottom: .5rem; */
    margin-bottom: calc(${intents.ux.box.density} * 1);
  }
  ...
  legend {
    ...
    padding: 0;
    margin-bottom: calc(${intents.ux.box.density} * 2);
    font-size: calc(${intents.ux.textParagraph.fontSize} * 1.5);
    line-height: inherit;
    color: inherit; /* 2 */
